...
class EditAdress3 extends Component {
            ...
            <View  style={styles.mainContainer}>
                ...
                <ScrollView>
                    <View style={styles.mainContentWrapper}>
                        <FontText style={styles.mainTitle}>Edit address</FontText>
                        ...
                        <View style={styles.buttonWrapper}>
                            <TouchableOpacity>
                                <View style={styles.addBtn}>
                                    <FontText style={styles.addText}>Edit</FontText>
                                </View>
                            </TouchableOpacity>
                        </View>
