...
class FloatingLabel extends Component {
    ...
    render() {
        ...
        return (
            <Animated.Text
                style={[styles.floatingLabel, {color: labelColor, top: this.state.paddingAnim, fontWeight:'bold', marginLeft:(Platform.OS === 'ios') ? 11 : 7},
                !this.props.focused && {color: this.props.inactiveColor, fontWeight:'normal', marginLeft:10}, {fontSize: this.state.fontSizeAnim}, !this.props.empty && {fontWeight: 'bold', marginLeft:(Platform.OS === 'ios') ? 11 : 7} ]}
            >
